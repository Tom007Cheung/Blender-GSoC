...
#+TITLE: Add more intelligent shortcut keys for outliner <draft>
...
* Deliverables
** Improvemt User Experience of Outliner.
   ...
   - Click the first item you want to choose, press /<Ctrl>/ and click other ones, you can choose them ignore the other between them.
...
* Project Details [3/6]
 ...
 path.\\
  ...
  - [X] Shift-select to select a range of items.\\
    It is related to *tree's traversal* problem, and shortcut keys binding.
